...
`Хорошо подойдут контейнеры, в них будет реализован функционал, а хранение данных сами системы не хранят как таковых данны, можно развернуть на Докере,
...
`Виртуализация, как хранилище данных контейнеры не предназначены`
